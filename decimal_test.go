...
func TestBig_Quo(t *testing.T) {
	...
	h1, ok := new(Big).SetString("10000000000000000000000000000000000000000")
	if !ok {
		t.Fatal("invalid")
	}
	h2, ok := new(Big).SetString("10000000000000000000000000000000000000000")
	if !ok {
		t.Fatal("invalid")
	}
	...
	tests := [...]struct {
		...
		{a: New(1000, 0), b: New(20, 0), r: "50"},
		{a: h1, b: h2, r: "1"},
		{a: New(100, 0), b: New(1, 0), r: "100"},
		{a: New(10, 0), b: New(1, 0), r: "10"},
		{a: New(1, 0), b: New(10, 0), r: "0.1"},
	}
	for i, v := range tests {
		if v.p != 0 {
			v.a.SetPrec(v.p)
